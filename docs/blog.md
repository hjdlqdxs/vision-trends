...
截至2023年时仅显示该年及之前的数据点；数量模式显示篇数，比例模式显示百分比。本项验收覆盖热度走势，不代替年度演变播放或关键词图谱联动的单独验收。
...
- 已按老师更新通知免费部署到Render，给出真实公网URL和访问截图；云端CRUD及单篇采集已有用户验证，批量TXT导入已有2/2成功截图，热度走势四项交互也已通过人工验收，未命中联网查询、图谱联动与年度演变等场景待补。
